...
SECRET_KEY = 'django-insecure-_n&4(uoxt&q4=!5@fz!)m=to&o*k9elc64l%w$=*bp)=mxz^*m'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,"projectdemo/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_PASSWORD= "vlpnnwpsoezngzza"
EMAIL_PORT= 587
EMAIL_USE_TLS= True
